...
public class Order {
	...
	private TimeSourceClass time = new TimeSourceClass();
	...
	public void confirm() {
		...
		int hoursElapsedAfterSubmittion = Hours.hoursBetween(subbmitionDate, new DateTime(time.currentTimeMilis())).getHours();
